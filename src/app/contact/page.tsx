...
import { SimpleWhatsApp } from '@/lib/simple-whatsapp';
import { 
  Phone, 
  Mail, 
  MapPin, 
...
const contactInfo = [
  ...
  },
  {
    icon: MapPin,
    title: 'Address',
    details: ['167 Jalan Bukit Merah, #06-12 Connection One', 'Singapore 150167'],
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await ContactService.sendAll(formData);

      if (result.email || result.whatsapp) {
        setSubmitStatus('success');
        console.log('Form submission results:', result);
        
        // Always open WhatsApp after form submission
        SimpleWhatsApp.openWhatsApp(formData, '+6586439469');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Contact Ask Engineering & Pte Ltd
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="mt-12 bg-red-50 border border-red-200 rounded-xl p-6">
                ...
                >
                  <Phone className="h-5 w-5" />
                  <span>Emergency: +65 8643 9469</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gray-200 rounded-2xl h-96 flex items-center justify-center">
            <iframe
              title="Google Map - 167 Jalan Bukit Merah, Singapore"
              src="https://www.google.com/maps?q=167+Jalan+Bukit+Merah,+%2306-12+Connection+One,+Singapore+150167&output=embed"
              width="100%"
              height="100%"
